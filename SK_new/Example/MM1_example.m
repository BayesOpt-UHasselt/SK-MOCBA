...
% The first part is to generate the evenly distributed design and prediction points, 
% and obtain the simulation outputs at design points. 
...
skriging_model_2 = SKfit_new(X,Y,B,Vhat,2,3);
SK_gau  = SKpredict_new(skriging_model_2,XK,BK);
